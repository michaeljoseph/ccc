...
copyright = u'{% now 'utc', '%Y' %}, {{cookiecutter.name}}'
...
texinfo_documents = [
  ('index', '{{cookiecutter.repo_name}}', u'{{cookiecutter.project_name}} Documentation',
   u'{{cookiecutter.name}}', '{{cookiecutter.repo_name}}', 'One line description of project.',
   'Miscellaneous'),
]
